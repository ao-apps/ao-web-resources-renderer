...
public class Renderer {
   ...
   *                     then to union the styles from all activated groups.
   *
   * @see  Renderer#renderStyles(jakarta.servlet.http.HttpServletRequest, jakarta.servlet.http.HttpServletResponse, com.aoapps.html.any.AnyUnion_Metadata_Phrasing, boolean, java.util.Map, java.lang.Iterable)
   */
  public void renderStyles(
      HttpServletRequest request,
      HttpServletResponse response,
   ...
   *                     then to union the scripts from all activated groups.
   *
   * @see  Renderer#renderScripts(jakarta.servlet.http.HttpServletRequest, jakarta.servlet.http.HttpServletResponse, com.aoapps.html.any.AnyScriptSupportingContent, boolean, java.util.Map, com.aoapps.web.resources.registry.Script.Position, java.lang.Iterable)
   */
  public void renderScripts(
      HttpServletRequest request,
      HttpServletResponse response,
